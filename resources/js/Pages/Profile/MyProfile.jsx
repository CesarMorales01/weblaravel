...
const MyProfile = (params) => {
    ...
    function validarActivarDivDireccion() {
        if (params.datosCliente.direccion != null || params.datosCliente.ciudad != null) {
    ...
    function validarDatosVaciosDir() {
        let lleno = false
        if (datosCliente.correo == '' || datosCliente.clave == '') {
            ...
            <AuthenticatedLayout user={params.auth} info={params.info} globalVars={params.globalVars} productos={params.productos} categorias={params.categorias}>
                <div className="container">
                    <form id='formRegistro' action={route('profile.update')} method="post" >
                        ...
                        <input type='hidden' name='id' value={params.auth.cedula}></input>
                        <br />
                        <hr />
                        {/* datos personales*/}
                        <div id="div_datos_personales" onMouseOver={activar_mensaje_datos_importantes} onMouseOut={desactivar_mensaje_datos_importantes} style={{ backgroundColor: '#f4f4f4', padding: '0.4em' }}>
                            ...
                            <div style={{ textAlign: 'center' }} className="row justify-content-center">
                                <div className="col-lg-6 col-sm-6" >
                                    <button onClick={validarFuncionBtnDatosPersonales} style={{ display: divDireccion ? 'none' : '', backgroundColor: '#f0e094' }} id="btn_modificar_datos_personales" className="btn btn-outline-success btn-md btn-block" type="button" >Modificar<i style={{ marginLeft: '1em' }} className="fas fa-edit"></i></button>
                                    ...
                                    {datosCliente.telefonos.map((item, index) => {
                                        return (
                                            <div key={index} style={{ margin: '1em' }} className="col-lg-2 col-md-2 col-sm-4 col-6 border">
                                                <p>{item}</p>
                                                <img alt='' className='rounded' onClick={() => borrarTelefono(item)} style={{ height: '1.2em', width: '1.2em', cursor: 'pointer', backgroundColor: 'red', padding: '0.1em', display: divDireccion ? 'none' : 'inline' }} src={params.globalVars.urlRoot + 'Images/Config/trash.png'} />
                                            </div>
                                        )
                                    })}
                                </div>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-8 col-sm-12" >
                                    ...
                                    <div style={{ backgroundColor: '#f4f4f4', padding: '0.3em' }}>
                                        ...
                                        <input name='correo' type="text" onClick={cambioCorreo} defaultValue={datosCliente.correo ? datosCliente.correo : ''} readOnly={divDireccion} className="form-control rounded" id="inputCorreo" />
                                        <br />
                                    </div>
                                    ...
                                    <div style={{ textAlign: 'center' }} className="row justify-content-center">
                                        <div className="col-lg-6 col-sm-6" >
                                            <button style={{ backgroundColor: '#f0e094' }} id="btnModificarUsuario" onClick={validarInfoDivs} className="btn btn-outline-success btn-md btn-block" type="button" >{divDireccion ? 'Desbloquear': 'Modificar'}<i style={{ marginLeft: '1em' }} className="fas fa-edit"></i></button>
