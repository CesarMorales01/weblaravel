                        ...
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link id='linkHome' href={route('index')}>
                                    <img className='img-fuild rounded' width="60em" height="60em" src={params.info.logo == '' ? params.globalVars.urlRoot + '/Imagenes_config/noPreview.jpg' : params.globalVars.urlRoot + "Images/Products/" + params.info.logo} />
                                </Link>
