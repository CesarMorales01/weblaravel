                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
                    <div className="flex justify-between h-16">
                        ...
                        <div className="hidden md:flex md:items-center md:ml-6">
                                    ...
                                    <Dropdown>
                                        <Dropdown.Trigger>
                                            <span className="inline-flex rounded-md">
                                                <button style={{ color: info.color_letra_navbar != '' ? info.color_letra_navbar : 'red' }} type="button"
                                                    className="inline-flex items-center px-3 py-2 text-md leading-4 font-medium rounded-md hover:text-gray-700 focus:outline-none transition ease-in-out duration-150" >
                                                    Categorias
                                        ...
                                        <Dropdown.Content>
                                            {categorias.map((item) => {
                                                return (
                                                    <Dropdown.Link info={info} key={item.id} href={route('product.search', item.nombre)}>{item.nombre}</Dropdown.Link>
                                                )
                                            })}
                            ...
                            <NavLink info={info} href={route('contact')} active={route().current('contact')}>
                                Contáctanos
                            </NavLink>
                            ...
                            <div className="ml-3 relative">
                                {user ?
                                    <Dropdown>
                                        ...
                                        <Dropdown.Content>
                                            <Dropdown.Link info={info} href={route('profile.edit', user.email)}>Cuenta</Dropdown.Link>
                                            <Dropdown.Link info={info} href={route('shopping.create')}>Mis compras</Dropdown.Link>
                                    ...
                                    <a href={route('gologin')} className="inline-flex rounded-md">
                                        <button style={{ color: info.color_letra_navbar != '' ? info.color_letra_navbar : 'black' }} type="button"
                                            className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150" >
                                            Ingresar
                                        </button>
                                    </a>
                    ...
                    <div className="pt-2 pb-3 space-y-1">
                        <Dropdown>
                            <Dropdown.Trigger>
                                <span className="inline-flex rounded-md">
                                    <button style={{ color: info.color_letra_navbar != '' ? info.color_letra_navbar : 'black' }} type="button"
                                        className="inline-flex items-center px-3 py-2 text-md leading-4 font-medium rounded-md text-black hover:text-gray-700 focus:outline-none transition ease-in-out duration-150" >
                                        Categorias
                                        <svg className="ml-2 -mr-0.5 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" >
                                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                                        </svg>
